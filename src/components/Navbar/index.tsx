...
const Navbar = () => {
    ...
    return (
        <nav className="fixed w-full h-24 shadow-xl bg-white font-sansnarrow">
            <div className="flex justify-between items-center h-full px-4">
                ...
                <div className="hidden sm:flex">
                    <ul className="hidden sm:flex text-xs mr-24">
                        <Link href="/">
            ...
            >
                ...
                <br />
                <br />
                <div className="flex-col py-4 text-white uppercase">
                    <ul>
                        <Link href="/">
                ...
                <div className="flex items-center text-white mt-5 ml-3 text-2xl">
                    <Link href={'/'}>
                    ...
                    <Link href={'/'}>
                        <AiOutlineWhatsApp className="m-2"/>
                    </Link>
                </div>
            </div>
        </nav>
